...
Valflux (Stage) -> Ce dossier contient uniquement ce que j'ai développé lors de mon stage, comme mon stage n'est pas fini, le code ne l'est pas non plus vous y trouverez plus d'exemples
	     		 plus d'exemple en php que le projet précédent.